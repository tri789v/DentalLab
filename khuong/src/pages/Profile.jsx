...
const Profile = (props) => {
    ...
    const fetchProfileByAccount = async () => {
        try {
            ...
            if (apiUrl) {
                const response = await authenticatedApiInstance(accessToken).get(`${apiUrl}/${userId}/dental`);
    ...
    const handleUpdateProfile = async () => {
        try {
            ...
            const response = await authenticatedApiInstance(accessToken).put(`${UPDATE_DENTAL_PROFILE}/${profileId}`, payload);
                    ...
                    <div class="bg-white space-y-6">
                        ...
                        <div class="md:inline-flex  space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
                            ...
                            <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                                ...
                                <button className="btn btn-primary" type="submit" onClick={handleUpdateProfile}>Cập nhật</button>
                            </div>
                        </div>
