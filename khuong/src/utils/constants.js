...
export const UPDATE_OR_DELTE_CATEGORY = (id) => `${BASE_API_URL}/categories/${id}`;
export const CREATE_NEW_PRODUCT = `${BASE_API_URL}/products`;
export const UPDATE_OR_DELTE_PRODUCT = (id) => `${BASE_API_URL}/products/${id}`;
