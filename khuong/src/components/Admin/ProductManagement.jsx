...
import { GET_ALL_ACCOUNT, GET_CATEGORY_URL, GET_PRODUCT_URL } from "../../utils/constants";
...
export function ProductManagement() {
    ...
    const HEADER_NAMES = ["ID", "Tên sản phẩm", "Mô tả", "Giá thành", "Trạng thái", "Loại vật liệu", "Thao tác"];
            ...
            <div class="">
                <div class="bg-white p-4 rounded-md mt-24">
                    <div className="flex w-full justify-between">
                        ...
                        <button class="btn btn-outline " onClick={() => document.getElementById('my_modal_1').showModal()}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="currentColor"
